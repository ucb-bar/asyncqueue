...
class AsyncResetShiftReg(w: Int = 1,
                         depth: Int = 1,
                         init: Int = 0,
                         name: String = "pipe") extends AbstractPipelineReg(w) {
...
class AsyncResetSynchronizerShiftReg(w: Int = 1,
                                     sync: Int = 3,
                                     init: Int = 0) extends AsyncResetShiftReg(w, depth = sync, init, name = "sync") {
...
class SyncResetSynchronizerShiftReg(w: Int = 1,
                                    sync: Int = 3,
                                    init: Int = 0) extends AbstractPipelineReg(w) {
